...
export default function AboutMe() {
  return (
    ...
    <div className="Container_AboutMe">
      ...
      <p>
        No ha sido una decisión fácil, pero sí una de las más emocionantes de mi
        vida. Estoy en pleno proceso de transformación profesional.
        <p>
          Cada línea de código, cada diseño, cada error y cada logro me conectan
          con una nueva versión de mí misma.
        </p>
      </p>
      <p>
        Me estoy reinventando, y lo estoy haciendo con una mezcla de entusiasmo,
        curiosidad y muchísima pasión.
      </p>
      <p>
        <p>He vuelto a ser aprendiz, y eso me llena de vida.</p>
        Mi meta no es solo dominar una nueva herramienta o tecnología; es{" "}
        <b>aportar valor real</b>, trabajar en proyectos que inspiren, y crecer
        junto a equipos que creen en la colaboración y en el aprendizaje
        constante.
      </p>
      <p>
